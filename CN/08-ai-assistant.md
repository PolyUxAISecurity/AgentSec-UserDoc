...
AI 助手面板包含标题栏、当前上下文提示、建议问题、对话区域、工具执行进度和输入框。用户可以在面板中直接提问，也可以点击建议问题快速开始。
...
**AI 在操作前会先检查配置**。例如您说「启动监控」，它会先确认监控目录、AI 模型和服务端连接是否可用。如果有问题，AI 会先指出需要修复的配置；确认无误后才会继续执行操作。
